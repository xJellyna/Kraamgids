...
export default function VindenClient() {
      ...
      <section className="rounded-3xl bg-white p-8 shadow-sm">
        ...
        <div className="mt-6 rounded-3xl bg-[#FFF6EC] p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <ChipButton active={typeFilter === "Alle"} onClick={() => setTypeFilter("Alle")}>
              Alle
            </ChipButton>
            <ChipButton
            ...
            <ChipButton active={onlyAvailable} onClick={() => setOnlyAvailable((v) => !v)}>
              Alleen beschikbaar
            </ChipButton>

            <ChipButton active={distance === "10"} onClick={() => setDistance("10")}>
              Binnen 10 km
            </ChipButton>
            <ChipButton active={distance === "25"} onClick={() => setDistance("25")}>
              Binnen 25 km
            </ChipButton>
            <ChipButton active={distance === "50"} onClick={() => setDistance("50")}>
              Binnen 50 km
            </ChipButton>
          </div>
        </div>
